...
/// Seq.Extensions.Logging is a thin wrapper on top) reaches /api/events/raw cleanly, the CLEF lines
/// it emits parse, and the resulting events land in storage with the expected fields.
/// </summary>
public sealed class SerilogSeqSinkCompatTests : IAsyncLifetime
{
	...
	public async Task Serilog_SeqSink_DeliversStructuredEventsThroughRawEndpoint()
	{
		...
		var logger = new LoggerConfiguration()
			...
			.WriteTo.Seq(
				serverUrl: _factory.Server.BaseAddress.ToString(),
