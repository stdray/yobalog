...
- [ ] **Фаза D — usability + админка.** Share links + маскирование UI; TSV export; live tail; hover-фильтры в таблице событий; админка для workspace/API-keys/retention/users.
